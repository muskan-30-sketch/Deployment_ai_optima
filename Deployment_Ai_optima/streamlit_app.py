...
with st.sidebar:
    st.image("https://via.placeholder.com/300x100?text=Dynamic+Pricing+System", use_container_width=True)
...
# ============================================================================
    ...
    if models_ok and feature_columns is not None:
        model_info = {
        ...
        st.warning("⚠️ Models not loaded. Feature information unavailable.")
